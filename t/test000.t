...
$preprocessor->setOption("inPath", "t/in/test000");
$preprocessor->setOption("outPath", "t/out/test000");
...
compare_ok("t/out/test000/file1.java", "t/oracle/test000/file1.java", "file1.java contents");
